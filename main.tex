...
\begin{definition}
     $n \leq 1$ に対し，
     $\Provable^n_T(\ulcorner \sigma \urcorner) \equiv \underbrace{\Provable_T(\ulcorner \cdots \Provable_T(\ulcorner}_{n} \sigma \urcorner) \cdots \urcorner)$ と定義する．
\end{definition}

これで，ひとまずは算術的完全性が証明出来る．

\begin{proof}[定理\ref{thm:GL_arith_completeness}の証明(3/3)]
